                            ...
                            <c:otherwise>
                                <c:forEach items="${requestScope.receiveLetters}" var="receiveLetter"
                                    ...
                                    <li class="list-group-item row">
                                        ...
                                        <span class='col-sm-1'>发送时间：<c:out
                                                value="${receiveLetter.timeReleased}"/>;</span>
                                        <c:if test="${receiveLetter.status==0}">
                                            <span class='col-sm-1' id='status<c:out
                                                value="${receiveLetter.letterID}"/>'>接收状态：未查收;</span>
                                        </c:if>
                                        <c:if test="${receiveLetter.status==1}">
                                <span class='col-sm-1'
                                      id='status<c:out value="${receiveLetter.letterID}"/>'>接收状态：已阅;</span>
                                        </c:if>
                                        <span class='col-sm-7 oneLeave'><c:out
                                                value="${receiveLetter.contents}"/></span>
                                        <span class='col-sm-1'>
                                ...
                                <section class="card-body">
                                    <form method="get" class="form-group" id="receive-form">
                                        <div class="row col-sm-12"><label for="sender">发信人：</label>
                                            <input class="form-control" name="sender" id="sender" readonly="readonly">
                                        </div>
                                        <div class="row col-sm-12"><label for="rece">收信人：</label>
                                            <input class="form-control" name="receiver" id="rece" readonly="readonly">
                                        </div>
                            ...
                            <div class="border card">
                                <section class="card-body">
                                    <form method="post" class="form-group" id="write-form">
                                        <input hidden id="userHiddenID" name="userID"
