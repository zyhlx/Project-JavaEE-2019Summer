...
<nav class="navbar nav-pills navbar-light navbar-fix" id="fixed-nar">
    ...
    <div class="col-sm-7 row justify-content-end">
        <ul class="nav nav-pills list-inline-item col-sm-10 justify-content-end " id="move">
            ...
            <li class="nav-item list-inline-item"><a href="#" class="nav-link"><i
                    class="fa fa-user-circle"></i><%= session.getAttribute("user")%>
            </a></li>
            <li class="nav-item list-inline-item"><a href="favours.jsp" class="nav-link"><i class="fa fa-user-plus"></i>收藏夹</a>
            </li>
            <%} else {%>
            <li class="nav-item list-inline-item">
