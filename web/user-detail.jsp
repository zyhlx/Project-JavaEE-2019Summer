...
<c:otherwise>
    ...
    <div>
    <ul class="list-group">
    <li class="list-group-item"><label for="username">用户名：</label><input id="username" type="text" name="username" placeholder="<c:out
        value="${requestScope.user.username}"/>" value="<c:out value="${requestScope.user.username}"/>"></li>
    <li class="list-group-item"><label for="email">邮箱：</label><input id="email" type="email" name="email" placeholder="<c:out
        value="${requestScope.user.email}"/>" value="<c:out value="${requestScope.user.email}"/>"></li>
    <li class="list-group-item"><label for="signature">个性签名：</label><input id="signature" type="text" name="signature" placeholder="<c:out
